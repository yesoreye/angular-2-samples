...
const resolvers = {
  Query:{
    me: function(){ return scrapeSpeaker('speakers/joakim-lundborg')},//()=>(scrapeSpeaker('speakers/joakim-lundborg')),
    speaker:function(id){ console.log(id); return scrapeSpeaker('speakers/'+id)}, //(scrapeSpeaker("speakers/"+id)),
    talks: () => { return talks },
  },
  Talk:{
    speakers: (talk)=>{
